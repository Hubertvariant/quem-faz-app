...
interface ProfessionalCardProps {
  fullName: string;
  avatar?: string; // Coloquei como opcional
}

export default function ProfessionalCard({ fullName, avatar }: ProfessionalCardProps) {
  return (
    <View className="mb-8">
      <Text className="text-lg font-bold text-slate-800 mb-3">O Profissional</Text>
      
      <View className="flex-row items-center bg-slate-50 p-4 rounded-3xl border border-slate-100">
